...
export default function Report() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 lg:ml-[18%] lg:w-[82%] mt-10">
      {/* Header */}
      <div className="mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Card className=" p-2 bg-gradient-to-br from-gray-900 to-indigo-950 border-gray-800 rounded-xl shadow-glow col-span-1">
